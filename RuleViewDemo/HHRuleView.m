...
- (void)setChooseValueTF {
    self.chooseValueTF = [[UITextField alloc] initWithFrame:CGRectMake(self.frame.size.width/2-85, 65, 170, 40)];
    ...
    UIImageView *lineView = [[UIImageView alloc] initWithFrame:CGRectMake(self.frame.size.width/2-50, 105, 100, 1)];
    ...
    self.descLabel.text = @"500~100000元";
